...
export function Admin() {
    ...
    return (
        <div
            data-lenis-prevent
            className="w-full max-h-7/12 flex flex-col md:flex-row text-white gap-6 p-4 max-w-10/12 mx-auto py-[120px]"
        >
            {/* Main Content Area */}
            <div className="flex-1 flex flex-col bg-neutral-800 rounded-xl overflow-hidden">
                {/* Header */}
