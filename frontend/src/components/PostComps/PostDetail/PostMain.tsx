    ...
    if (loading) {
        return (
            <FadeIn direction="up" duration={700} delay={1300}>
                <section className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 md:p-10 mb-8 animate-pulse">
    ...
    if (error) {
        return (
            <FadeIn direction="up" duration={700} delay={200}>
                <section className="bg-red-50 dark:bg-red-900/20 rounded-2xl shadow-lg p-6 md:p-10 mb-8">
