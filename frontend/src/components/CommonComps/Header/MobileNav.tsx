    ...
    return (
        <div className="lg:hidden">
            ...
            <button
                ...
                className={`fixed top-3 right-8 z-60 w-10 h-10 flex flex-col justify-center items-center gap-1.5 rounded-md shadow-md transition-transform duration-300 ${
            ...
            {isOpen && (
                <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-40" onClick={() => setIsOpen(false)} aria-hidden="true" />
            )}
